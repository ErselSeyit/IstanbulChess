...
/////////////// gelen ////////////////////////////////
    socket.on('oyuna_girildi', function(param){
      ...
      if (param.taraf == 's'){
          ...
          $('#rakipoyuncu').removeClass('metin-yazi-beyaz')
          $('#rakipoyuncu').removeClass('metin-arka-siyah');
          $('#rakipoyuncu').removeClass('metin-yazi-siyah')
          $('#rakipoyuncu').removeClass('metin-arka-beyaz');
          $('#rakipoyuncu').addClass('metin-yazi-siyah')
          $('#rakipoyuncu').addClass('metin-arka-beyaz');
           
          $('#rakipdetay').removeClass('metin-yazi-beyaz')
          $('#rakipdetay').removeClass('metin-arka-siyah');
          $('#rakipdetay').removeClass('metin-yazi-siyah')
          $('#rakipdetay').removeClass('metin-arka-beyaz');
          $('#rakipdetay').addClass('metin-yazi-siyah')
          $('#rakipdetay').addClass('metin-arka-beyaz');
          if (param.bos=='off'){
          ...
          $('#yereloyuncu').removeClass('metin-yazi-beyaz')
          $('#yereloyuncu').removeClass('metin-arka-siyah');
          $('#yereloyuncu').removeClass('metin-yazi-siyah')
          $('#yereloyuncu').removeClass('metin-arka-beyaz');
          $('#yereloyuncu').addClass('metin-yazi-beyaz')
          $('#yereloyuncu').addClass('metin-arka-siyah');
          
          $('#yereldetay').removeClass('metin-yazi-beyaz')
          $('#yereldetay').removeClass('metin-arka-siyah');
          $('#yereldetay').removeClass('metin-yazi-siyah')
          $('#yereldetay').removeClass('metin-arka-beyaz');
          $('#yereldetay').addClass('metin-yazi-beyaz')
          $('#yereldetay').addClass('metin-arka-siyah');
      ...
      if (param.taraf == 'b'){
          ...
          $('#yereloyuncu').removeClass('metin-yazi-siyah')
          $('#yereloyuncu').removeClass('metin-arka-beyaz');
          $('#yereloyuncu').addClass('metin-yazi-siyah')
          $('#yereloyuncu').addClass('metin-arka-beyaz');
          
          $('#yereldetay').removeClass('metin-yazi-beyaz')
          $('#yereldetay').removeClass('metin-arka-siyah');
          $('#yereldetay').removeClass('metin-yazi-siyah')
          $('#yereldetay').removeClass('metin-arka-beyaz');
          $('#yereldetay').addClass('metin-yazi-siyah')
          $('#yereldetay').addClass('metin-arka-beyaz');
          if (param.sos=='off'){
             $('#yereldurum').children().css('fill', 'red');
          } else
          {  
          ...
          $('#rakipoyuncu').removeClass('metin-yazi-siyah')
          $('#rakipoyuncu').removeClass('metin-arka-beyaz');
          $('#rakipoyuncu').addClass('metin-yazi-beyaz')
          $('#rakipoyuncu').addClass('metin-arka-siyah');
          
          $('#rakipdetay').removeClass('metin-yazi-beyaz')
          $('#rakipdetay').removeClass('metin-arka-siyah');
          $('#rakipdetay').removeClass('metin-yazi-siyah')
          $('#rakipdetay').removeClass('metin-arka-beyaz');
          $('#rakipdetay').addClass('metin-yazi-beyaz')
          $('#rakipdetay').addClass('metin-arka-siyah');
    ...
    socket.on('oyunlar', function(oyuncular){
      ...
      for (var key=0, size=oyuncular.length; key<size;key++) {
        ...
        html += '<tr><td>'
             ...
             + oyuncular[key]['puani']
             + '</td><td>'
             + '<button class="metin-button metin-kucuk metin-daire metin-dalga metin-sagda" onclick="oyun_oyna('+String.fromCharCode(39)+oyuncular[key]['kullanici']+String.fromCharCode(39)+')">'+langJS['oyna']+'</button>'
             + '</td></tr>';
      };
    ...
    socket.on('konum',function(data){
        ...
        if (data.ok=='o'){
           ...
           if (data.ber !== ''){
              $('#berabere').removeClass('metin-arka-gri');
              $('#berabere').addClass('metin-amber'); 
           } else {
              $('#berabere').removeClass('metin-amber');
              $('#berabere').addClass('metin-arka-gri'); 
           }
...
/////////////////// menu /////////////////////////////////
    ...
    function metin_ac() {
        akordeon_bolum_kapat();
        document.getElementsByClassName("metin-dikey-menu")[0].style.display = "block";
    };
    
    function metin_kapat() {
        clearInterval(sayac);
        document.getElementsByClassName("metin-dikey-menu")[0].style.display = "none";
    };
...
//////////////// görünüm /////////////////
    ...
    if (ind==0)
        ...
        $("#masa a").removeClass("metin-arka-acik-gri");
        $("#m"+ind).addClass("metin-arka-acik-gri");
    ...
    function tassec(ind){
        ...
        if (ind!=tas) { 
          ...
          $("#tas a").removeClass("metin-arka-acik-gri");
          $("#t"+ind).addClass("metin-arka-acik-gri"); 
...
////////////////// masa olayları /////////////////////
    function tasayarla(a){
        if (a==='Vezir'){
            tas='q';
            $("#q").removeClass("metin-arka-gri");
            $("#r").addClass("metin-arka-gri");
            $("#b").addClass("metin-arka-gri");
            $("#n").addClass("metin-arka-gri");
        } else
        if (a==='Kale'){
            tas='r';
            $("#q").addClass("metin-arka-gri");
            $("#r").removeClass("metin-arka-gri");
            $("#b").addClass("metin-arka-gri");
            $("#n").addClass("metin-arka-gri");
        } else
	    if (a==='Fil'){
