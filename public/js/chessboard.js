...
function calculateSquareSize() {
  ...
  var containerHeight = $(window).height()-232;
  if (containerHeight<containerWidth) containerWidth=containerHeight;
  ...
  $(".ersel-alan").css("padding-top",(containerHeight-boardWidth)/2);
  return (boardWidth / 8);
}
